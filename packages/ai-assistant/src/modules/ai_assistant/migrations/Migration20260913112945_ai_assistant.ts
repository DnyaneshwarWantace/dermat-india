...
export class Migration20260913112945_ai_assistant extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`alter table "ai_token_usage_daily" alter column "input_tokens" drop default;`);
    this.addSql(`alter table "ai_token_usage_daily" alter column "output_tokens" drop default;`);
    this.addSql(`alter table "ai_token_usage_daily" alter column "cached_input_tokens" drop default;`);
    this.addSql(`alter table "ai_token_usage_daily" alter column "reasoning_tokens" drop default;`);
    this.addSql(`alter table "ai_token_usage_daily" alter column "step_count" drop default;`);
    this.addSql(`alter table "ai_token_usage_daily" alter column "turn_count" drop default;`);
    this.addSql(`alter table "ai_token_usage_daily" alter column "session_count" drop default;`);

    this.addSql(`drop index "ai_token_usage_events_tenant_agent_created_idx";`);
    this.addSql(`drop index "ai_token_usage_events_tenant_created_idx";`);
    this.addSql(`drop index "ai_token_usage_events_tenant_model_created_idx";`);
    this.addSql(`create index "ai_token_usage_events_tenant_agent_created_idx" on "ai_token_usage_events" ("tenant_id", "agent_id", "created_at");`);
    this.addSql(`create index "ai_token_usage_events_tenant_created_idx" on "ai_token_usage_events" ("tenant_id", "created_at");`);
    this.addSql(`create index "ai_token_usage_events_tenant_model_created_idx" on "ai_token_usage_events" ("tenant_id", "model_id", "created_at");`);
  }
  ...
  override down(): void | Promise<void> {
    ...
    this.addSql(`alter table "ai_token_usage_daily" alter column "input_tokens" set default 0;`);
    this.addSql(`alter table "ai_token_usage_daily" alter column "output_tokens" set default 0;`);
    this.addSql(`alter table "ai_token_usage_daily" alter column "cached_input_tokens" set default 0;`);
    this.addSql(`alter table "ai_token_usage_daily" alter column "reasoning_tokens" set default 0;`);
    this.addSql(`alter table "ai_token_usage_daily" alter column "step_count" set default 0;`);
    this.addSql(`alter table "ai_token_usage_daily" alter column "turn_count" set default 0;`);
    this.addSql(`alter table "ai_token_usage_daily" alter column "session_count" set default 0;`);
