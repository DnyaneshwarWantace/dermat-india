...
export class Migration20260913112951_checkout extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`alter index "checkout_links_organization_id_tenant_id_status_de_49f3b_index" rename to "checkout_links_organization_id_tenant_id_status_de_98718_index";`);

    this.addSql(`alter index "checkout_link_templates_organization_id_tenant_id__9eeb6_index" rename to "checkout_link_templates_organization_id_tenant_id__49503_index";`);

    this.addSql(`drop index "checkout_transactions_organization_id_tenant_id_li_7548d_index";`);
    this.addSql(`create index "checkout_transactions_organization_id_tenant_id_li_93a69_index" on "checkout_transactions" ("organization_id", "tenant_id", "link_id", "idempotency_key");`);
    this.addSql(`alter index "checkout_transactions_organization_id_tenant_id_cr_d105e_index" rename to "checkout_transactions_organization_id_tenant_id_cr_acbc1_index";`);
    this.addSql(`alter index "checkout_transactions_organization_id_tenant_id_li_e6e13_index" rename to "checkout_transactions_organization_id_tenant_id_li_fec94_index";`);
  }
  ...
  override down(): void | Promise<void> {
    ...
    this.addSql(`alter index "checkout_link_templates_organization_id_tenant_id__49503_index" rename to "checkout_link_templates_organization_id_tenant_id__9eeb6_index";`);

    this.addSql(`drop index "checkout_links_slug_index";`);
    this.addSql(`create unique index "checkout_links_slug_index" on "checkout_links" ("slug") where deleted_at IS NULL;`);
    this.addSql(`alter index "checkout_links_organization_id_tenant_id_status_de_98718_index" rename to "checkout_links_organization_id_tenant_id_status_de_49f3b_index";`);

    this.addSql(`drop index "checkout_transactions_organization_id_tenant_id_li_93a69_index";`);
    ...
    this.addSql(`alter index "checkout_transactions_organization_id_tenant_id_cr_acbc1_index" rename to "checkout_transactions_organization_id_tenant_id_cr_d105e_index";`);
    this.addSql(`alter index "checkout_transactions_organization_id_tenant_id_li_fec94_index" rename to "checkout_transactions_organization_id_tenant_id_li_e6e13_index";`);
  }
