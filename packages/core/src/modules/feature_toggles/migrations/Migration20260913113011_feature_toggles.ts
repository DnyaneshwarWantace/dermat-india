...
export class Migration20260913113011_feature_toggles extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`alter table "feature_toggle_overrides" add constraint "feature_toggle_overrides_toggle_id_foreign" foreign key ("toggle_id") references "feature_toggles" ("id");`);
  }
