...
export class Migration20260913113005_dictionaries extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`drop index "dictionary_entries_one_default_per_dict";`);
    this.addSql(`alter table "dictionary_entries" add constraint "dictionary_entries_dictionary_id_foreign" foreign key ("dictionary_id") references "dictionaries" ("id");`);
  }
