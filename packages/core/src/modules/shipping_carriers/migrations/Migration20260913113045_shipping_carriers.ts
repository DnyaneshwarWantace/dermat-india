...
export class Migration20260913113045_shipping_carriers extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`alter index "carrier_shipments_organization_id_tenant_id_unif_b5ab4_index" rename to "carrier_shipments_organization_id_tenant_id_unifie_47ae1_index";`);
    this.addSql(`alter index "carrier_shipments_provider_key_carrier_shipment_i_f9f17_index" rename to "carrier_shipments_provider_key_carrier_shipment_id_f580a_index";`);
  }
  ...
  override down(): void | Promise<void> {
    ...
    this.addSql(`alter index "carrier_shipments_organization_id_tenant_id_unifie_47ae1_index" rename to "carrier_shipments_organization_id_tenant_id_unif_b5ab4_index";`);
    this.addSql(`alter index "carrier_shipments_provider_key_carrier_shipment_id_f580a_index" rename to "carrier_shipments_provider_key_carrier_shipment_i_f9f17_index";`);
  }
