...
export class Migration20260913113031_purchasing extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`alter table "purchasing_purchase_invoices" alter column "subtotal_cents" set default '0';`);
    this.addSql(`alter table "purchasing_purchase_invoices" alter column "tax_cents" set default '0';`);
    this.addSql(`alter table "purchasing_purchase_invoices" alter column "total_cents" set default '0';`);
    this.addSql(`alter table "purchasing_purchase_invoices" alter column "paid_cents" set default '0';`);
    this.addSql(`alter table "purchasing_purchase_invoices" alter column "balance_cents" set default '0';`);

    this.addSql(`alter table "purchasing_purchase_invoice_lines" alter column "line_total" set default '0';`);

    this.addSql(`alter table "purchasing_purchase_orders" alter column "subtotal_cents" set default '0';`);
    this.addSql(`alter table "purchasing_purchase_orders" alter column "tax_cents" set default '0';`);
    this.addSql(`alter table "purchasing_purchase_orders" alter column "total_cents" set default '0';`);

    this.addSql(`alter table "purchasing_purchase_order_lines" alter column "line_total" set default '0';`);
  }
