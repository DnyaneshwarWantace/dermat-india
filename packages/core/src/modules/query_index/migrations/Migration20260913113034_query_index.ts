...
export class Migration20260913113034_query_index extends Migration {
  ...
  override down(): void | Promise<void> {
    ...
    this.addSql(`alter table "indexer_status_logs" alter column "occurred_at" set default now();`);
  }
