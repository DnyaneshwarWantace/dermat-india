...
export class Migration20260913112958_data_sync extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`drop index "sync_cursors_integration_id_entity_type_direction__b4d87_index";`);
    this.addSql(`create index "sync_cursors_integration_id_entity_type_direction__255ea_index" on "sync_cursors" ("integration_id", "entity_type", "direction", "organization_id", "tenant_id");`);

    this.addSql(`drop index "sync_mappings_integration_id_entity_type_organizat_edee9_index";`);
    this.addSql(`create index "sync_mappings_integration_id_entity_type_organizat_7aa92_index" on "sync_mappings" ("integration_id", "entity_type", "organization_id", "tenant_id");`);

    this.addSql(`alter index "sync_runs_integration_id_entity_type_status_organi_8b13b_index" rename to "sync_runs_integration_id_entity_type_status_organi_43560_index";`);

    this.addSql(`alter index "sync_schedules_integration_id_entity_type_directio_addb9_index" rename to "sync_schedules_integration_id_entity_type_directio_fe28d_index";`);
  }
  ...
  override down(): void | Promise<void> {
    ...
    this.addSql(`drop index "sync_cursors_integration_id_entity_type_direction__255ea_index";`);
    ...
    this.addSql(`drop index "sync_mappings_integration_id_entity_type_organizat_7aa92_index";`);
    ...
    this.addSql(`alter index "sync_runs_integration_id_entity_type_status_organi_43560_index" rename to "sync_runs_integration_id_entity_type_status_organi_8b13b_index";`);

    this.addSql(`alter index "sync_schedules_integration_id_entity_type_directio_fe28d_index" rename to "sync_schedules_integration_id_entity_type_directio_addb9_index";`);
  }
