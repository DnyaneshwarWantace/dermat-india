...
export class Migration20260913113014_manufacturing extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`alter table "manufacturing_bom_lines" drop constraint if exists "fk_mfg_bom_lines_bom";`);
    this.addSql(`alter table "manufacturing_bom_lines" drop constraint if exists "fk_mfg_bom_lines_sub_bom";`);
    this.addSql(`alter table "manufacturing_bom_operations" drop constraint if exists "fk_mfg_bom_ops_bom";`);
    this.addSql(`alter table "manufacturing_production_orders" drop constraint if exists "fk_mfg_po_bom";`);
    ...
    this.addSql(`alter table "wms_stock_valuations" drop constraint if exists "fk_wms_sv_lot";`);
    ...
    this.addSql(`alter table "wms_stock_valuations" drop constraint if exists "fk_wms_sv_warehouse";`);
    ...
    this.addSql(`create table "manufacturing_boms" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "metadata" jsonb null, "created_at" timestamptz not null, "updated_at" timestamptz null, "deleted_at" timestamptz null, "name" text not null, "code" text not null, "description" text null, "product_variant_id" uuid not null, "product_name" text not null, "output_quantity" numeric(15,4) not null, "unit_of_measure" text null, "status" text not null default 'draft', "version" int not null default 1, "is_default" boolean not null default false, "material_cost_cents" bigint not null default '0', "operation_cost_cents" bigint not null default '0', "total_cost_cents" bigint not null default '0', "notes" text null, primary key ("id"));`);
    this.addSql(`create index "mfg_bom_product_idx" on "manufacturing_boms" ("organization_id", "product_variant_id");`);
    this.addSql(`create unique index "mfg_bom_org_code_unique_idx" on "manufacturing_boms" ("organization_id", "code") where deleted_at is null;`);
    this.addSql(`create index "mfg_bom_org_tenant_idx" on "manufacturing_boms" ("organization_id", "tenant_id");`);

    this.addSql(`alter table "manufacturing_bom_operations" drop constraint if exists "fk_mfg_bom_ops_machine";`);
    this.addSql(`alter table "manufacturing_bom_operations" drop constraint if exists "fk_mfg_bom_ops_wc";`);

    this.addSql(`alter table "manufacturing_material_consumptions" drop constraint if exists "fk_mfg_mc_bom_line";`);
    this.addSql(`alter table "manufacturing_material_consumptions" drop constraint if exists "fk_mfg_mc_po";`);

    this.addSql(`alter table "manufacturing_production_stages" drop constraint if exists "fk_mfg_ps_machine";`);
    this.addSql(`alter table "manufacturing_production_stages" drop constraint if exists "fk_mfg_ps_po";`);
    this.addSql(`alter table "manufacturing_production_stages" drop constraint if exists "fk_mfg_ps_wc";`);

    this.addSql(`alter table "manufacturing_quality_inspections" drop constraint if exists "fk_mfg_qi_po";`);
    this.addSql(`alter table "manufacturing_quality_inspections" drop constraint if exists "fk_mfg_qi_ps";`);

    this.addSql(`alter table "manufacturing_quality_check_items" drop constraint if exists "fk_mfg_qci_inspection";`);

    this.addSql(`alter table "manufacturing_machines" drop constraint if exists "fk_mfg_machines_wc";`);

    this.addSql(`alter table "manufacturing_bom_lines" add "line_total" bigint not null default '0';`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "line_number" drop default;`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "product_variant_id" set not null;`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "product_name" type text using ("product_name"::text);`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "product_name" set not null;`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "product_sku" type text using ("product_sku"::text);`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "quantity" drop default;`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "unit_of_measure" type text using ("unit_of_measure"::text);`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "wastage_percent" set default '0';`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "unit_cost_cents" drop default;`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "created_at" drop default;`);
    this.addSql(`alter table "manufacturing_bom_lines" add constraint "manufacturing_bom_lines_bom_id_foreign" foreign key ("bom_id") references "manufacturing_boms" ("id");`);
    this.addSql(`create index "mfg_bl_product_idx" on "manufacturing_bom_lines" ("organization_id", "product_variant_id");`);
    this.addSql(`create index "mfg_bl_org_tenant_idx" on "manufacturing_bom_lines" ("organization_id", "tenant_id");`);
    this.addSql(`alter index "idx_mfg_bom_lines_bom" rename to "mfg_bl_bom_idx";`);

    this.addSql(`alter table "manufacturing_bom_operations" alter column "sequence_number" drop default;`);
    this.addSql(`alter table "manufacturing_bom_operations" alter column "name" type text using ("name"::text);`);
    this.addSql(`alter table "manufacturing_bom_operations" alter column "setup_time_minutes" set default '0';`);
    this.addSql(`alter table "manufacturing_bom_operations" alter column "run_time_minutes" set default '0';`);
    this.addSql(`alter table "manufacturing_bom_operations" alter column "cost_cents" set default '0';`);
    this.addSql(`alter table "manufacturing_bom_operations" alter column "created_at" drop default;`);
    this.addSql(`alter table "manufacturing_bom_operations" add constraint "manufacturing_bom_operations_bom_id_foreign" foreign key ("bom_id") references "manufacturing_boms" ("id");`);
    this.addSql(`create index "mfg_bo_wc_idx" on "manufacturing_bom_operations" ("work_center_id");`);
    this.addSql(`create index "mfg_bo_org_tenant_idx" on "manufacturing_bom_operations" ("organization_id", "tenant_id");`);
    this.addSql(`alter index "idx_mfg_bom_ops_bom" rename to "mfg_bo_bom_idx";`);

    this.addSql(`drop index "idx_mfg_po_order_number_org";`);
    this.addSql(`drop index "idx_mfg_po_status";`);
    this.addSql(`drop index "idx_mfg_po_tenant_org";`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "produced_quantity" set default '0';`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "rejected_quantity" set default '0';`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "material_cost_cents" set default '0';`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "labor_cost_cents" set default '0';`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "overhead_cost_cents" set default '0';`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "total_cost_cents" set default '0';`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "created_at" drop default;`);
    this.addSql(`create unique index "mfg_po_order_number_unique_idx" on "manufacturing_production_orders" ("organization_id", "order_number") where deleted_at is null;`);
    this.addSql(`create index "mfg_po_org_tenant_idx" on "manufacturing_production_orders" ("organization_id", "tenant_id");`);
    this.addSql(`alter index "idx_mfg_po_bom" rename to "mfg_po_bom_idx";`);

    this.addSql(`drop index "idx_mfg_mc_tenant_org";`);
    this.addSql(`alter table "manufacturing_material_consumptions" alter column "actual_quantity" set default '0';`);
    this.addSql(`alter table "manufacturing_material_consumptions" alter column "wastage_quantity" set default '0';`);
    this.addSql(`alter table "manufacturing_material_consumptions" alter column "unit_cost_cents" set default '0';`);
    this.addSql(`alter table "manufacturing_material_consumptions" alter column "created_at" drop default;`);
    this.addSql(`alter table "manufacturing_material_consumptions" add constraint "manufacturing_material_consumptions_production_order_id_foreign" foreign key ("production_order_id") references "manufacturing_production_orders" ("id");`);
    this.addSql(`create index "mfg_mc_org_tenant_idx2" on "manufacturing_material_consumptions" ("organization_id", "tenant_id");`);
    this.addSql(`alter index "idx_mfg_mc_po" rename to "mfg_mc_po_idx";`);

    this.addSql(`drop index "idx_mfg_ps_tenant_org";`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "produced_quantity" set default '0';`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "rejected_quantity" set default '0';`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "planned_setup_minutes" set default '0';`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "planned_run_minutes" set default '0';`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "actual_setup_minutes" set default '0';`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "actual_run_minutes" set default '0';`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "created_at" drop default;`);
    this.addSql(`alter table "manufacturing_production_stages" add constraint "manufacturing_production_stages_production_order_id_foreign" foreign key ("production_order_id") references "manufacturing_production_orders" ("id");`);
    this.addSql(`create index "mfg_ps_org_tenant_idx" on "manufacturing_production_stages" ("organization_id", "tenant_id");`);
    this.addSql(`alter index "idx_mfg_ps_po" rename to "mfg_ps_po_idx";`);

    this.addSql(`alter table "manufacturing_production_stage_templates" alter column "created_at" drop default;`);
    this.addSql(`alter table "manufacturing_production_stage_templates" alter column "updated_at" drop default;`);

    this.addSql(`drop index "idx_mfg_qi_number_org";`);
    this.addSql(`drop index "idx_mfg_qi_tenant_org";`);
    this.addSql(`alter table "manufacturing_quality_inspections" alter column "inspected_quantity" set default '0';`);
    this.addSql(`alter table "manufacturing_quality_inspections" alter column "passed_quantity" set default '0';`);
    this.addSql(`alter table "manufacturing_quality_inspections" alter column "failed_quantity" set default '0';`);
    this.addSql(`alter table "manufacturing_quality_inspections" alter column "created_at" drop default;`);
    this.addSql(`create unique index "mfg_qi_number_unique_idx" on "manufacturing_quality_inspections" ("organization_id", "inspection_number") where deleted_at is null;`);
    this.addSql(`create index "mfg_qi_org_tenant_idx" on "manufacturing_quality_inspections" ("organization_id", "tenant_id");`);

    this.addSql(`drop index "idx_mfg_qci_tenant_org";`);
    this.addSql(`alter table "manufacturing_quality_check_items" alter column "created_at" drop default;`);
    this.addSql(`alter table "manufacturing_quality_check_items" add constraint "manufacturing_quality_check_items_inspection_id_foreign" foreign key ("inspection_id") references "manufacturing_quality_inspections" ("id");`);
    this.addSql(`create index "mfg_qci_org_tenant_idx" on "manufacturing_quality_check_items" ("organization_id", "tenant_id");`);
    this.addSql(`alter index "idx_mfg_qci_inspection" rename to "mfg_qci_inspection_idx";`);

    this.addSql(`drop index "idx_mfg_wc_code_org";`);
    this.addSql(`drop index "idx_mfg_wc_tenant_org";`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "name" type text using ("name"::text);`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "code" type text using ("code"::text);`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "status" type text using ("status"::text);`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "cost_per_hour_cents" set default '0';`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "unit_of_measure" type text using ("unit_of_measure"::text);`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "location" type text using ("location"::text);`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "created_at" drop default;`);
    this.addSql(`create unique index "mfg_wc_org_code_unique_idx" on "manufacturing_work_centers" ("organization_id", "code") where deleted_at is null;`);
    this.addSql(`create index "mfg_wc_org_tenant_idx" on "manufacturing_work_centers" ("organization_id", "tenant_id");`);

    this.addSql(`drop index "idx_mfg_machines_code_org";`);
    this.addSql(`drop index "idx_mfg_machines_tenant_org";`);
    this.addSql(`alter table "manufacturing_machines" alter column "name" type text using ("name"::text);`);
    this.addSql(`alter table "manufacturing_machines" alter column "code" type text using ("code"::text);`);
    this.addSql(`alter table "manufacturing_machines" alter column "status" type text using ("status"::text);`);
    this.addSql(`alter table "manufacturing_machines" alter column "make_model" type text using ("make_model"::text);`);
    this.addSql(`alter table "manufacturing_machines" alter column "serial_number" type text using ("serial_number"::text);`);
    this.addSql(`alter table "manufacturing_machines" alter column "created_at" drop default;`);
    this.addSql(`alter table "manufacturing_machines" add constraint "manufacturing_machines_work_center_id_foreign" foreign key ("work_center_id") references "manufacturing_work_centers" ("id") on delete set null;`);
    this.addSql(`create unique index "mfg_mc_org_code_unique_idx" on "manufacturing_machines" ("organization_id", "code") where deleted_at is null;`);
    this.addSql(`create index "mfg_mc_org_tenant_idx" on "manufacturing_machines" ("organization_id", "tenant_id");`);
    this.addSql(`alter index "idx_mfg_machines_wc" rename to "mfg_mc_wc_idx";`);
  }

  override down(): void | Promise<void> {
    this.addSql(`alter table "manufacturing_bom_lines" drop constraint if exists "manufacturing_bom_lines_bom_id_foreign";`);
    this.addSql(`alter table "manufacturing_bom_operations" drop constraint if exists "manufacturing_bom_operations_bom_id_foreign";`);
    ...
    this.addSql(`create table "manufacturing_bill_of_materials" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "name" varchar(255) not null, "code" varchar(100) not null, "description" text null, "product_variant_id" uuid null, "product_name" varchar(255) null, "product_sku" varchar(255) null, "output_quantity" numeric(15,4) not null default 1, "unit_of_measure" varchar(50) null, "status" varchar(50) not null default 'draft', "version" int4 not null default 1, "is_default" bool not null default false, "material_cost_cents" int8 not null default 0, "operation_cost_cents" int8 not null default 0, "total_cost_cents" int8 not null default 0, "notes" text null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, constraint "manufacturing_bom_pkey" primary key ("id"));`);
    this.addSql(`create unique index "idx_mfg_bom_code_org" on "manufacturing_bill_of_materials" ("organization_id", "code") where deleted_at IS NULL;`);
    this.addSql(`create index "idx_mfg_bom_product" on "manufacturing_bill_of_materials" ("product_variant_id");`);
    this.addSql(`create index "idx_mfg_bom_tenant_org" on "manufacturing_bill_of_materials" ("tenant_id", "organization_id");`);
    ...
    this.addSql(`create table "mikro_orm_migrations_dermat_departments" ("id" serial primary key, "name" varchar(255) not null, "executed_at" timestamptz(6) not null default current_timestamp(6));`);
    ...
    this.addSql(`create table "mikro_orm_migrations_purchasing" ("id" serial primary key, "name" varchar(255) not null, "executed_at" timestamptz(6) not null default current_timestamp(6));`);
    ...
    this.addSql(`create table "purchasing_goods_receipts" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "metadata" jsonb null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, "receipt_number" text not null, "purchase_order_id" uuid not null, "status" text not null default 'draft', "receipt_date" timestamptz(6) not null, "warehouse_id" uuid null, "received_by_user_id" uuid null, "notes" text null, primary key ("id"));`);
    ...
    this.addSql(`create table "purchasing_purchase_invoice_lines" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "metadata" jsonb null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, "purchase_invoice_id" uuid not null, "purchase_order_line_id" uuid null, "line_number" int4 not null, "product_variant_id" uuid null, "product_name" text not null, "description" text null, "quantity" numeric(15,4) not null, "unit_of_measure" text null, "unit_price_cents" int8 not null, "line_total" int8 not null default 0, "tax_rate" numeric(5,2) null, "notes" text null, primary key ("id"));`);
    ...
    this.addSql(`create table "purchasing_purchase_invoices" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "metadata" jsonb null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, "invoice_number" text not null, "supplier_invoice_number" text null, "supplier_id" uuid not null, "purchase_order_id" uuid null, "goods_receipt_id" uuid null, "status" text not null default 'draft', "invoice_date" timestamptz(6) not null, "due_date" timestamptz(6) null, "currency_code" text null, "subtotal_cents" int8 not null default 0, "tax_cents" int8 not null default 0, "total_cents" int8 not null default 0, "paid_cents" int8 not null default 0, "balance_cents" int8 not null default 0, "payment_terms" text null, "approved_by_user_id" uuid null, "approved_at" timestamptz(6) null, "notes" text null, primary key ("id"));`);
    ...
    this.addSql(`create table "purchasing_purchase_order_lines" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "metadata" jsonb null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, "purchase_order_id" uuid not null, "line_number" int4 not null, "product_variant_id" uuid null, "product_name" text not null, "product_sku" text null, "description" text null, "quantity" numeric(15,4) not null, "unit_of_measure" text null, "unit_price_cents" int8 not null, "line_total" int8 not null default 0, "tax_rate" numeric(5,2) null, "received_quantity" numeric(15,4) not null default '0', "status" text not null default 'pending', "notes" text null, primary key ("id"));`);
    ...
    this.addSql(`create table "purchasing_purchase_orders" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "metadata" jsonb null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, "order_number" text not null, "supplier_id" uuid not null, "status" text not null default 'draft', "order_date" timestamptz(6) not null, "expected_delivery_date" timestamptz(6) null, "warehouse_id" uuid null, "currency_code" text null, "subtotal_cents" int8 not null default 0, "tax_cents" int8 not null default 0, "total_cents" int8 not null default 0, "payment_terms" text null, "shipping_method" text null, "created_by_user_id" uuid null, "approved_by_user_id" uuid null, "approved_at" timestamptz(6) null, "notes" text null, primary key ("id"));`);
    ...
    this.addSql(`create table "purchasing_supplier_pricing" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "metadata" jsonb null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, "supplier_id" uuid not null, "product_variant_id" uuid not null, "product_name" text not null, "product_sku" text null, "unit_price_cents" int8 not null, "currency_code" text null, "min_quantity" numeric(15,4) not null default '1', "lead_time_days" int4 null, "valid_from" timestamptz(6) null, "valid_to" timestamptz(6) null, "is_active" bool not null default true, "notes" text null, primary key ("id"));`);
    ...
    this.addSql(`create table "wms_stock_valuations" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "warehouse_id" uuid not null, "catalog_variant_id" uuid not null, "lot_id" uuid null, "quantity_on_hand" numeric(16,4) not null default 0, "unit_cost_cents" int8 not null default 0, "total_value_cents" int8 not null default 0, "valuation_method" text not null default 'weighted_average', "last_purchase_cost_cents" int8 null, "standard_cost_cents" int8 null, "currency_code" text not null default 'INR', "last_valued_at" timestamptz(6) null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, primary key ("id"));`);
    this.addSql(`create index "wms_stock_valuations_org_tenant_idx" on "wms_stock_valuations" ("organization_id", "tenant_id");`);
    this.addSql(`create index "wms_stock_valuations_variant_warehouse_idx" on "wms_stock_valuations" ("organization_id", "catalog_variant_id", "warehouse_id") where deleted_at IS NULL;`);
    ...
    this.addSql(`alter table "purchasing_goods_receipt_lines" add constraint "purchasing_goods_receipt_lines_goods_receipt_id_foreign" foreign key ("goods_receipt_id") references "purchasing_goods_receipts" ("id") on update no action on delete no action;`);

    this.addSql(`alter table "purchasing_goods_receipts" add constraint "purchasing_goods_receipts_purchase_order_id_foreign" foreign key ("purchase_order_id") references "purchasing_purchase_orders" ("id") on update no action on delete no action;`);

    this.addSql(`alter table "purchasing_purchase_invoice_lines" add constraint "purchasing_purchase_invoice_lines_purchase_invoice_id_foreign" foreign key ("purchase_invoice_id") references "purchasing_purchase_invoices" ("id") on update no action on delete no action;`);

    this.addSql(`alter table "purchasing_purchase_order_lines" add constraint "purchasing_purchase_order_lines_purchase_order_id_foreign" foreign key ("purchase_order_id") references "purchasing_purchase_orders" ("id") on update no action on delete no action;`);

    this.addSql(`alter table "purchasing_purchase_orders" add constraint "purchasing_purchase_orders_supplier_id_foreign" foreign key ("supplier_id") references "purchasing_suppliers" ("id") on update no action on delete no action;`);

    this.addSql(`alter table "purchasing_supplier_pricing" add constraint "purchasing_supplier_pricing_supplier_id_foreign" foreign key ("supplier_id") references "purchasing_suppliers" ("id") on update no action on delete no action;`);
    ...
    this.addSql(`alter table "wms_stock_valuations" add constraint "fk_wms_sv_lot" foreign key ("lot_id") references "wms_inventory_lots" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "wms_stock_valuations" add constraint "fk_wms_sv_warehouse" foreign key ("warehouse_id") references "wms_warehouses" ("id") on update cascade on delete cascade;`);
    ...
    this.addSql(`alter table "manufacturing_machines" drop constraint if exists "manufacturing_machines_work_center_id_foreign";`);

    this.addSql(`alter table "manufacturing_material_consumptions" drop constraint if exists "manufacturing_material_consumptions_production_order_id_foreign";`);

    this.addSql(`alter table "manufacturing_production_stages" drop constraint if exists "manufacturing_production_stages_production_order_id_foreign";`);

    this.addSql(`alter table "manufacturing_quality_check_items" drop constraint if exists "manufacturing_quality_check_items_inspection_id_foreign";`);

    this.addSql(`drop index "mfg_bl_product_idx";`);
    this.addSql(`drop index "mfg_bl_org_tenant_idx";`);
    this.addSql(`alter table "manufacturing_bom_lines" drop column "line_total";`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "created_at" set default now();`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "line_number" set default 1;`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "product_variant_id" drop not null;`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "product_name" type varchar(255) using ("product_name"::varchar(255));`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "product_name" drop not null;`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "product_sku" type varchar(255) using ("product_sku"::varchar(255));`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "quantity" set default 1;`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "unit_of_measure" type varchar(50) using ("unit_of_measure"::varchar(50));`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "wastage_percent" set default 0;`);
    this.addSql(`alter table "manufacturing_bom_lines" alter column "unit_cost_cents" set default 0;`);
    this.addSql(`alter table "manufacturing_bom_lines" add constraint "fk_mfg_bom_lines_bom" foreign key ("bom_id") references "manufacturing_bill_of_materials" ("id") on update cascade on delete cascade;`);
    this.addSql(`alter table "manufacturing_bom_lines" add constraint "fk_mfg_bom_lines_sub_bom" foreign key ("sub_bom_id") references "manufacturing_bill_of_materials" ("id") on update cascade on delete set null;`);
    this.addSql(`alter index "mfg_bl_bom_idx" rename to "idx_mfg_bom_lines_bom";`);

    this.addSql(`drop index "mfg_bo_wc_idx";`);
    this.addSql(`drop index "mfg_bo_org_tenant_idx";`);
    this.addSql(`alter table "manufacturing_bom_operations" alter column "created_at" set default now();`);
    this.addSql(`alter table "manufacturing_bom_operations" alter column "sequence_number" set default 1;`);
    this.addSql(`alter table "manufacturing_bom_operations" alter column "name" type varchar(255) using ("name"::varchar(255));`);
    this.addSql(`alter table "manufacturing_bom_operations" alter column "setup_time_minutes" set default 0;`);
    this.addSql(`alter table "manufacturing_bom_operations" alter column "run_time_minutes" set default 0;`);
    this.addSql(`alter table "manufacturing_bom_operations" alter column "cost_cents" set default 0;`);
    this.addSql(`alter table "manufacturing_bom_operations" add constraint "fk_mfg_bom_ops_bom" foreign key ("bom_id") references "manufacturing_bill_of_materials" ("id") on update cascade on delete cascade;`);
    this.addSql(`alter table "manufacturing_bom_operations" add constraint "fk_mfg_bom_ops_machine" foreign key ("machine_id") references "manufacturing_machines" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "manufacturing_bom_operations" add constraint "fk_mfg_bom_ops_wc" foreign key ("work_center_id") references "manufacturing_work_centers" ("id") on update cascade on delete set null;`);
    this.addSql(`alter index "mfg_bo_bom_idx" rename to "idx_mfg_bom_ops_bom";`);

    this.addSql(`drop index "mfg_mc_org_code_unique_idx";`);
    this.addSql(`drop index "mfg_mc_org_tenant_idx";`);
    this.addSql(`alter table "manufacturing_machines" alter column "created_at" set default now();`);
    this.addSql(`alter table "manufacturing_machines" alter column "name" type varchar(255) using ("name"::varchar(255));`);
    this.addSql(`alter table "manufacturing_machines" alter column "code" type varchar(100) using ("code"::varchar(100));`);
    this.addSql(`alter table "manufacturing_machines" alter column "status" type varchar(50) using ("status"::varchar(50));`);
    this.addSql(`alter table "manufacturing_machines" alter column "make_model" type varchar(255) using ("make_model"::varchar(255));`);
    this.addSql(`alter table "manufacturing_machines" alter column "serial_number" type varchar(255) using ("serial_number"::varchar(255));`);
    this.addSql(`alter table "manufacturing_machines" add constraint "fk_mfg_machines_wc" foreign key ("work_center_id") references "manufacturing_work_centers" ("id") on update cascade on delete set null;`);
    this.addSql(`create unique index "idx_mfg_machines_code_org" on "manufacturing_machines" ("organization_id", "code") where deleted_at IS NULL;`);
    this.addSql(`create index "idx_mfg_machines_tenant_org" on "manufacturing_machines" ("tenant_id", "organization_id");`);
    this.addSql(`alter index "mfg_mc_wc_idx" rename to "idx_mfg_machines_wc";`);

    this.addSql(`drop index "mfg_mc_org_tenant_idx2";`);
    this.addSql(`alter table "manufacturing_material_consumptions" alter column "created_at" set default now();`);
    this.addSql(`alter table "manufacturing_material_consumptions" alter column "actual_quantity" set default 0;`);
    this.addSql(`alter table "manufacturing_material_consumptions" alter column "wastage_quantity" set default 0;`);
    this.addSql(`alter table "manufacturing_material_consumptions" alter column "unit_cost_cents" set default 0;`);
    this.addSql(`alter table "manufacturing_material_consumptions" add constraint "fk_mfg_mc_bom_line" foreign key ("bom_line_id") references "manufacturing_bom_lines" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "manufacturing_material_consumptions" add constraint "fk_mfg_mc_po" foreign key ("production_order_id") references "manufacturing_production_orders" ("id") on update cascade on delete cascade;`);
    this.addSql(`create index "idx_mfg_mc_tenant_org" on "manufacturing_material_consumptions" ("tenant_id", "organization_id");`);
    this.addSql(`alter index "mfg_mc_po_idx" rename to "idx_mfg_mc_po";`);

    this.addSql(`drop index "mfg_po_order_number_unique_idx";`);
    this.addSql(`drop index "mfg_po_org_tenant_idx";`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "created_at" set default now();`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "produced_quantity" set default 0;`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "rejected_quantity" set default 0;`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "material_cost_cents" set default 0;`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "labor_cost_cents" set default 0;`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "overhead_cost_cents" set default 0;`);
    this.addSql(`alter table "manufacturing_production_orders" alter column "total_cost_cents" set default 0;`);
    this.addSql(`alter table "manufacturing_production_orders" add constraint "fk_mfg_po_bom" foreign key ("bom_id") references "manufacturing_bill_of_materials" ("id") on update cascade on delete restrict;`);
    this.addSql(`create unique index "idx_mfg_po_order_number_org" on "manufacturing_production_orders" ("organization_id", "order_number") where deleted_at IS NULL;`);
    this.addSql(`create index "idx_mfg_po_status" on "manufacturing_production_orders" ("organization_id", "status") where deleted_at IS NULL;`);
    this.addSql(`create index "idx_mfg_po_tenant_org" on "manufacturing_production_orders" ("tenant_id", "organization_id");`);
    this.addSql(`alter index "mfg_po_bom_idx" rename to "idx_mfg_po_bom";`);

    this.addSql(`alter table "manufacturing_production_stage_templates" alter column "created_at" set default now();`);
    this.addSql(`alter table "manufacturing_production_stage_templates" alter column "updated_at" set default now();`);

    this.addSql(`drop index "mfg_ps_org_tenant_idx";`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "created_at" set default now();`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "produced_quantity" set default 0;`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "rejected_quantity" set default 0;`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "planned_setup_minutes" set default 0;`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "planned_run_minutes" set default 0;`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "actual_setup_minutes" set default 0;`);
    this.addSql(`alter table "manufacturing_production_stages" alter column "actual_run_minutes" set default 0;`);
    this.addSql(`alter table "manufacturing_production_stages" add constraint "fk_mfg_ps_machine" foreign key ("machine_id") references "manufacturing_machines" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "manufacturing_production_stages" add constraint "fk_mfg_ps_po" foreign key ("production_order_id") references "manufacturing_production_orders" ("id") on update cascade on delete cascade;`);
    this.addSql(`alter table "manufacturing_production_stages" add constraint "fk_mfg_ps_wc" foreign key ("work_center_id") references "manufacturing_work_centers" ("id") on update cascade on delete set null;`);
    this.addSql(`create index "idx_mfg_ps_tenant_org" on "manufacturing_production_stages" ("tenant_id", "organization_id");`);
    this.addSql(`alter index "mfg_ps_po_idx" rename to "idx_mfg_ps_po";`);

    this.addSql(`drop index "mfg_qci_org_tenant_idx";`);
    this.addSql(`alter table "manufacturing_quality_check_items" alter column "created_at" set default now();`);
    this.addSql(`alter table "manufacturing_quality_check_items" add constraint "fk_mfg_qci_inspection" foreign key ("inspection_id") references "manufacturing_quality_inspections" ("id") on update cascade on delete cascade;`);
    this.addSql(`create index "idx_mfg_qci_tenant_org" on "manufacturing_quality_check_items" ("tenant_id", "organization_id");`);
    this.addSql(`alter index "mfg_qci_inspection_idx" rename to "idx_mfg_qci_inspection";`);

    this.addSql(`drop index "mfg_qi_number_unique_idx";`);
    this.addSql(`drop index "mfg_qi_org_tenant_idx";`);
    this.addSql(`alter table "manufacturing_quality_inspections" alter column "created_at" set default now();`);
    this.addSql(`alter table "manufacturing_quality_inspections" alter column "inspected_quantity" set default 0;`);
    this.addSql(`alter table "manufacturing_quality_inspections" alter column "passed_quantity" set default 0;`);
    this.addSql(`alter table "manufacturing_quality_inspections" alter column "failed_quantity" set default 0;`);
    this.addSql(`alter table "manufacturing_quality_inspections" add constraint "fk_mfg_qi_po" foreign key ("production_order_id") references "manufacturing_production_orders" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "manufacturing_quality_inspections" add constraint "fk_mfg_qi_ps" foreign key ("production_stage_id") references "manufacturing_production_stages" ("id") on update cascade on delete set null;`);
    this.addSql(`create unique index "idx_mfg_qi_number_org" on "manufacturing_quality_inspections" ("organization_id", "inspection_number") where deleted_at IS NULL;`);
    this.addSql(`create index "idx_mfg_qi_tenant_org" on "manufacturing_quality_inspections" ("tenant_id", "organization_id");`);

    this.addSql(`drop index "mfg_wc_org_code_unique_idx";`);
    this.addSql(`drop index "mfg_wc_org_tenant_idx";`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "created_at" set default now();`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "name" type varchar(255) using ("name"::varchar(255));`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "code" type varchar(100) using ("code"::varchar(100));`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "status" type varchar(50) using ("status"::varchar(50));`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "cost_per_hour_cents" set default 0;`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "unit_of_measure" type varchar(50) using ("unit_of_measure"::varchar(50));`);
    this.addSql(`alter table "manufacturing_work_centers" alter column "location" type varchar(255) using ("location"::varchar(255));`);
    this.addSql(`create unique index "idx_mfg_wc_code_org" on "manufacturing_work_centers" ("organization_id", "code") where deleted_at IS NULL;`);
    this.addSql(`create index "idx_mfg_wc_tenant_org" on "manufacturing_work_centers" ("tenant_id", "organization_id");`);
  }
