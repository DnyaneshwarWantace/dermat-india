...
export class Migration20260913113027_payment_gateways extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`alter index "gateway_transactions_organization_id_tenant_id_uni_5a9b9_index" rename to "gateway_transactions_organization_id_tenant_id_uni_358ac_index";`);
    this.addSql(`alter index "gateway_transactions_provider_key_provider_session_d8577_index" rename to "gateway_transactions_provider_key_provider_session_750f8_index";`);
  ...
  override down(): void | Promise<void> {
    ...
    this.addSql(`alter index "gateway_transactions_organization_id_tenant_id_uni_358ac_index" rename to "gateway_transactions_organization_id_tenant_id_uni_5a9b9_index";`);
    this.addSql(`alter index "gateway_transactions_provider_key_provider_session_750f8_index" rename to "gateway_transactions_provider_key_provider_session_d8577_index";`);

    this.addSql(`alter table "gateway_webhook_events" drop constraint if exists "gateway_webhook_events_idempotency_unique";`);
