...
export class Migration20260913113019_notifications extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`drop index "notifications_expires_idx";`);
    this.addSql(`drop index "notifications_group_idx";`);
    this.addSql(`drop index "notifications_recipient_status_idx";`);
    this.addSql(`drop index "notifications_source_idx";`);
  ...
  override down(): void | Promise<void> {
    ...
    this.addSql(`drop index "notifications_source_idx";`);
    this.addSql(`drop index "notifications_recipient_status_idx";`);
    this.addSql(`alter table "notifications" alter column "created_at" set default now();`);
