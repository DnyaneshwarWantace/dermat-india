...
export class Migration20260913113008_directory extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`alter table "organizations" add constraint "organizations_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id");`);
  }
