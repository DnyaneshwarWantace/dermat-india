...
export class Migration20260913113039_sales extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`alter table "sales_quotes" add constraint "sales_quotes_channel_ref_id_foreign" foreign key ("channel_ref_id") references "sales_channels" ("id") on delete set null;`);
    this.addSql(`alter table "sales_quotes" add constraint "sales_quotes_delivery_window_ref_id_foreign" foreign key ("delivery_window_ref_id") references "sales_delivery_windows" ("id") on delete set null;`);
    this.addSql(`alter table "sales_quotes" add constraint "sales_quotes_payment_method_ref_id_foreign" foreign key ("payment_method_ref_id") references "sales_payment_methods" ("id") on delete set null;`);
    this.addSql(`alter table "sales_quotes" add constraint "sales_quotes_shipping_method_ref_id_foreign" foreign key ("shipping_method_ref_id") references "sales_shipping_methods" ("id") on delete set null;`);

    this.addSql(`alter table "sales_quote_lines" add constraint "sales_quote_lines_quote_id_foreign" foreign key ("quote_id") references "sales_quotes" ("id");`);

    this.addSql(`alter table "sales_quote_adjustments" add constraint "sales_quote_adjustments_quote_id_foreign" foreign key ("quote_id") references "sales_quotes" ("id");`);
    this.addSql(`alter table "sales_quote_adjustments" add constraint "sales_quote_adjustments_quote_line_id_foreign" foreign key ("quote_line_id") references "sales_quote_lines" ("id") on delete set null;`);

    this.addSql(`alter table "sales_orders" add constraint "sales_orders_channel_ref_id_foreign" foreign key ("channel_ref_id") references "sales_channels" ("id") on delete set null;`);
    this.addSql(`alter table "sales_orders" add constraint "sales_orders_delivery_window_ref_id_foreign" foreign key ("delivery_window_ref_id") references "sales_delivery_windows" ("id") on delete set null;`);
    this.addSql(`alter table "sales_orders" add constraint "sales_orders_payment_method_ref_id_foreign" foreign key ("payment_method_ref_id") references "sales_payment_methods" ("id") on delete set null;`);
    this.addSql(`alter table "sales_orders" add constraint "sales_orders_shipping_method_ref_id_foreign" foreign key ("shipping_method_ref_id") references "sales_shipping_methods" ("id") on delete set null;`);

    this.addSql(`alter table "sales_shipments" add constraint "sales_shipments_order_id_foreign" foreign key ("order_id") references "sales_orders" ("id");`);

    this.addSql(`alter table "sales_returns" add constraint "sales_returns_order_id_foreign" foreign key ("order_id") references "sales_orders" ("id");`);

    this.addSql(`alter table "sales_payments" add constraint "sales_payments_order_id_foreign" foreign key ("order_id") references "sales_orders" ("id") on delete set null;`);
    this.addSql(`alter table "sales_payments" add constraint "sales_payments_payment_method_id_foreign" foreign key ("payment_method_id") references "sales_payment_methods" ("id") on delete set null;`);
    ...
    this.addSql(`alter table "sales_shipment_items" add constraint "sales_shipment_items_order_line_id_foreign" foreign key ("order_line_id") references "sales_order_lines" ("id");`);
    this.addSql(`alter table "sales_shipment_items" add constraint "sales_shipment_items_shipment_id_foreign" foreign key ("shipment_id") references "sales_shipments" ("id");`);

    this.addSql(`alter table "sales_return_lines" add constraint "sales_return_lines_order_line_id_foreign" foreign key ("order_line_id") references "sales_order_lines" ("id");`);
    this.addSql(`alter table "sales_return_lines" add constraint "sales_return_lines_return_id_foreign" foreign key ("return_id") references "sales_returns" ("id");`);

    this.addSql(`alter table "sales_order_adjustments" add constraint "sales_order_adjustments_order_id_foreign" foreign key ("order_id") references "sales_orders" ("id");`);
    this.addSql(`alter table "sales_order_adjustments" add constraint "sales_order_adjustments_order_line_id_foreign" foreign key ("order_line_id") references "sales_order_lines" ("id") on delete set null;`);

    this.addSql(`alter table "sales_notes" add constraint "sales_notes_order_id_foreign" foreign key ("order_id") references "sales_orders" ("id") on delete set null;`);
    this.addSql(`alter table "sales_notes" add constraint "sales_notes_quote_id_foreign" foreign key ("quote_id") references "sales_quotes" ("id") on delete set null;`);

    this.addSql(`alter table "sales_invoices" add constraint "sales_invoices_order_id_foreign" foreign key ("order_id") references "sales_orders" ("id") on delete set null;`);

    this.addSql(`alter table "sales_payment_allocations" add constraint "sales_payment_allocations_invoice_id_foreign" foreign key ("invoice_id") references "sales_invoices" ("id") on delete set null;`);
    this.addSql(`alter table "sales_payment_allocations" add constraint "sales_payment_allocations_order_id_foreign" foreign key ("order_id") references "sales_orders" ("id") on delete set null;`);
    this.addSql(`alter table "sales_payment_allocations" add constraint "sales_payment_allocations_payment_id_foreign" foreign key ("payment_id") references "sales_payments" ("id");`);

    this.addSql(`alter table "sales_invoice_lines" add constraint "sales_invoice_lines_invoice_id_foreign" foreign key ("invoice_id") references "sales_invoices" ("id");`);
    this.addSql(`alter table "sales_invoice_lines" add constraint "sales_invoice_lines_order_line_id_foreign" foreign key ("order_line_id") references "sales_order_lines" ("id") on delete set null;`);

    this.addSql(`alter table "sales_document_tag_assignments" add constraint "sales_document_tag_assignments_order_id_foreign" foreign key ("order_id") references "sales_orders" ("id") on delete set null;`);
    this.addSql(`alter table "sales_document_tag_assignments" add constraint "sales_document_tag_assignments_quote_id_foreign" foreign key ("quote_id") references "sales_quotes" ("id") on delete set null;`);
    this.addSql(`alter table "sales_document_tag_assignments" add constraint "sales_document_tag_assignments_tag_id_foreign" foreign key ("tag_id") references "sales_document_tags" ("id");`);

    this.addSql(`alter table "sales_document_addresses" add constraint "sales_document_addresses_order_id_foreign" foreign key ("order_id") references "sales_orders" ("id") on delete set null;`);
    this.addSql(`alter table "sales_document_addresses" add constraint "sales_document_addresses_quote_id_foreign" foreign key ("quote_id") references "sales_quotes" ("id") on delete set null;`);

    this.addSql(`alter table "sales_credit_memos" add constraint "sales_credit_memos_invoice_id_foreign" foreign key ("invoice_id") references "sales_invoices" ("id") on delete set null;`);
    this.addSql(`alter table "sales_credit_memos" add constraint "sales_credit_memos_order_id_foreign" foreign key ("order_id") references "sales_orders" ("id") on delete set null;`);

    this.addSql(`alter table "sales_credit_memo_lines" add constraint "sales_credit_memo_lines_credit_memo_id_foreign" foreign key ("credit_memo_id") references "sales_credit_memos" ("id");`);
    this.addSql(`alter table "sales_credit_memo_lines" add constraint "sales_credit_memo_lines_order_line_id_foreign" foreign key ("order_line_id") references "sales_order_lines" ("id") on delete set null;`);
  }
  ...
  override down(): void | Promise<void> {
    ...
    this.addSql(`create table "manufacturing_bom_lines" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "bom_id" uuid not null, "line_number" int4 not null default 1, "product_variant_id" uuid null, "product_name" varchar(255) null, "product_sku" varchar(255) null, "quantity" numeric(15,4) not null default 1, "unit_of_measure" varchar(50) null, "wastage_percent" numeric(5,2) not null default 0, "unit_cost_cents" int8 not null default 0, "is_critical" bool not null default false, "sub_bom_id" uuid null, "notes" text null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, primary key ("id"));`);
    this.addSql(`create index "idx_mfg_bom_lines_bom" on "manufacturing_bom_lines" ("bom_id");`);

    this.addSql(`create table "manufacturing_bom_operations" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "bom_id" uuid not null, "sequence_number" int4 not null default 1, "name" varchar(255) not null, "description" text null, "work_center_id" uuid null, "machine_id" uuid null, "setup_time_minutes" numeric(10,2) not null default 0, "run_time_minutes" numeric(10,2) not null default 0, "cost_cents" int8 not null default 0, "notes" text null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, primary key ("id"));`);
    this.addSql(`create index "idx_mfg_bom_ops_bom" on "manufacturing_bom_operations" ("bom_id");`);

    this.addSql(`create table "manufacturing_machines" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "name" varchar(255) not null, "code" varchar(100) not null, "description" text null, "status" varchar(50) not null default 'available', "work_center_id" uuid null, "make_model" varchar(255) null, "serial_number" varchar(255) null, "purchase_date" timestamptz(6) null, "last_maintenance_date" timestamptz(6) null, "next_maintenance_date" timestamptz(6) null, "notes" text null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, primary key ("id"));`);
    ...
    this.addSql(`create index "idx_mfg_machines_wc" on "manufacturing_machines" ("work_center_id");`);

    this.addSql(`create table "manufacturing_material_consumptions" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "production_order_id" uuid not null, "bom_line_id" uuid null, "product_variant_id" uuid not null, "product_name" text not null, "product_sku" text null, "planned_quantity" numeric(15,4) not null, "actual_quantity" numeric(15,4) not null default 0, "wastage_quantity" numeric(15,4) not null default 0, "unit_of_measure" text null, "unit_cost_cents" int8 not null default 0, "status" text not null default 'planned', "warehouse_id" uuid null, "lot_id" uuid null, "issued_at" timestamptz(6) null, "issued_by" uuid null, "notes" text null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, primary key ("id"));`);
    this.addSql(`create index "idx_mfg_mc_po" on "manufacturing_material_consumptions" ("production_order_id");`);
    this.addSql(`create index "idx_mfg_mc_tenant_org" on "manufacturing_material_consumptions" ("tenant_id", "organization_id");`);

    this.addSql(`create table "manufacturing_production_orders" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "order_number" text not null, "bom_id" uuid not null, "bom_name" text not null, "product_variant_id" uuid not null, "product_name" text not null, "planned_quantity" numeric(15,4) not null, "produced_quantity" numeric(15,4) not null default 0, "rejected_quantity" numeric(15,4) not null default 0, "unit_of_measure" text null, "status" text not null default 'draft', "priority" text not null default 'normal', "planned_start_date" timestamptz(6) null, "planned_end_date" timestamptz(6) null, "actual_start_date" timestamptz(6) null, "actual_end_date" timestamptz(6) null, "warehouse_id" uuid null, "material_cost_cents" int8 not null default 0, "labor_cost_cents" int8 not null default 0, "overhead_cost_cents" int8 not null default 0, "total_cost_cents" int8 not null default 0, "notes" text null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, "sales_order_id" uuid null, "sales_order_number" text null, primary key ("id"));`);
    this.addSql(`create index "idx_mfg_po_bom" on "manufacturing_production_orders" ("bom_id");`);
    ...
    this.addSql(`create table "manufacturing_production_stage_templates" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) null default now(), "deleted_at" timestamptz(6) null, "name" text not null, "code" text not null, "description" text null, "sequence_number" int4 not null, "is_active" bool not null default true, "default_work_center_id" uuid null, "default_machine_id" uuid null, "estimated_setup_minutes" numeric(10,2) not null default '0', "estimated_run_minutes" numeric(10,2) not null default '0', "requires_quality_check" bool not null default false, "notes" text null, primary key ("id"));`);
    ...
    this.addSql(`create table "manufacturing_production_stages" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "production_order_id" uuid not null, "sequence_number" int4 not null, "name" text not null, "description" text null, "work_center_id" uuid null, "machine_id" uuid null, "status" text not null default 'pending', "planned_quantity" numeric(15,4) not null, "produced_quantity" numeric(15,4) not null default 0, "rejected_quantity" numeric(15,4) not null default 0, "planned_setup_minutes" numeric(10,2) not null default 0, "planned_run_minutes" numeric(10,2) not null default 0, "actual_setup_minutes" numeric(10,2) not null default 0, "actual_run_minutes" numeric(10,2) not null default 0, "started_at" timestamptz(6) null, "completed_at" timestamptz(6) null, "operator_id" uuid null, "notes" text null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, primary key ("id"));`);
    this.addSql(`create index "idx_mfg_ps_po" on "manufacturing_production_stages" ("production_order_id");`);
    this.addSql(`create index "idx_mfg_ps_tenant_org" on "manufacturing_production_stages" ("tenant_id", "organization_id");`);

    this.addSql(`create table "manufacturing_quality_check_items" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "inspection_id" uuid not null, "check_name" text not null, "description" text null, "specification" text null, "min_value" numeric(15,4) null, "max_value" numeric(15,4) null, "measured_value" numeric(15,4) null, "text_value" text null, "result" text null, "notes" text null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, primary key ("id"));`);
    this.addSql(`create index "idx_mfg_qci_inspection" on "manufacturing_quality_check_items" ("inspection_id");`);
    this.addSql(`create index "idx_mfg_qci_tenant_org" on "manufacturing_quality_check_items" ("tenant_id", "organization_id");`);

    this.addSql(`create table "manufacturing_quality_inspections" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "inspection_number" text not null, "inspection_type" text not null, "status" text not null default 'pending', "production_order_id" uuid null, "production_stage_id" uuid null, "product_variant_id" uuid not null, "product_name" text not null, "inspected_quantity" numeric(15,4) not null default 0, "passed_quantity" numeric(15,4) not null default 0, "failed_quantity" numeric(15,4) not null default 0, "overall_result" text null, "inspector_id" uuid null, "inspected_at" timestamptz(6) null, "notes" text null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, primary key ("id"));`);
    ...
    this.addSql(`create table "manufacturing_work_centers" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "name" varchar(255) not null, "code" varchar(100) not null, "description" text null, "status" varchar(50) not null default 'active', "cost_per_hour_cents" int8 not null default 0, "capacity_per_day" numeric(15,4) null, "unit_of_measure" varchar(50) null, "location" varchar(255) null, "notes" text null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, primary key ("id"));`);
    ...
    this.addSql(`create table "mikro_orm_migrations_manufacturing" ("id" serial primary key, "name" varchar(255) not null, "executed_at" timestamptz(6) not null default current_timestamp(6));`);
