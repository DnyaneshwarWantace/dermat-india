...
export class Migration20260913113012_integrations extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`alter index "integration_credentials_integration_id_organizatio_291ea_index" rename to "integration_credentials_integration_id_organizatio_58963_index";`);

    this.addSql(`alter index "integration_logs_level_organization_id_tenant_id_c_107e7_index" rename to "integration_logs_level_organization_id_tenant_id_c_af75d_index";`);
    this.addSql(`alter index "integration_logs_integration_id_organization_id_te_38189_index" rename to "integration_logs_integration_id_organization_id_te_41dbc_index";`);

    this.addSql(`alter index "integration_states_integration_id_organization_id__32acc_index" rename to "integration_states_integration_id_organization_id__8b1c1_index";`);

    this.addSql(`alter index "sync_external_id_mappings_integration_id_external__c088c_index" rename to "sync_external_id_mappings_integration_id_external__063e8_index";`);
    this.addSql(`alter index "sync_external_id_mappings_internal_entity_type_int_f9194_index" rename to "sync_external_id_mappings_internal_entity_type_int_7f84a_index";`);
  }
  ...
  override down(): void | Promise<void> {
    ...
    this.addSql(`alter index "integration_credentials_integration_id_organizatio_58963_index" rename to "integration_credentials_integration_id_organizatio_291ea_index";`);

    this.addSql(`alter index "integration_logs_integration_id_organization_id_te_41dbc_index" rename to "integration_logs_integration_id_organization_id_te_38189_index";`);
    this.addSql(`alter index "integration_logs_level_organization_id_tenant_id_c_af75d_index" rename to "integration_logs_level_organization_id_tenant_id_c_107e7_index";`);

    this.addSql(`alter index "integration_states_integration_id_organization_id__8b1c1_index" rename to "integration_states_integration_id_organization_id__32acc_index";`);

    this.addSql(`alter index "sync_external_id_mappings_integration_id_external__063e8_index" rename to "sync_external_id_mappings_integration_id_external__c088c_index";`);
    this.addSql(`alter index "sync_external_id_mappings_internal_entity_type_int_7f84a_index" rename to "sync_external_id_mappings_internal_entity_type_int_f9194_index";`);
  }
