      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className="sm:max-w-md" onKeyDown={handleKeyDown}>
          <DialogHeader className="items-center gap-3">
            <div className="h-12 w-12 rounded-xl bg-primary text-primary-foreground font-bold text-lg flex items-center justify-center shadow-xs">
              DI
            </div>
            <DialogTitle className="text-center text-xl">
              {t('demoFeedback.dialog.title', 'Dermat India ERP Support')}
            </DialogTitle>
